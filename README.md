...
9. We have `Procfile` in the project. If you don't have the file, you can create it and add these:
  * `web: vendor/bin/heroku-php-apache2` for apache server
  * `web: vendor/bin/heroku-php-nginx` for nginx server
  * `web: vendor/bin/heroku-php-apache2 public/` to specify the root of the app
