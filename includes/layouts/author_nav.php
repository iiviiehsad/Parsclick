	...
	<section class="navbar">
		<ul class="nav navbar-nav">
			<li class="<?php echo active(['author']); ?>">
				<a href="author.php"><i class="fa fa-home fa-lg"></i> خانه</a>
			</li>
			<li class="<?php echo active(['author_profile', 'author_edit_profile']); ?>">
				<a href="author_profile.php"><i class="fa fa-pencil-square fa-lg"></i> حساب کاربری</a>
			</li>
			<li class="dropdown
			<?php echo active([
					'author_courses',
			...
			">
				...
				<ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu">
					<li class="<?php echo active(['author_courses', 'new_course', 'author_edit_course',]); ?>">
						<a tabindex="-1" href="author_courses.php"><i class="fa fa-film fa-lg"></i> دروس</a>
					</li>
					<li class="<?php echo active(['author_articles', 'new_article', 'author_edit_article']); ?>">
						<a tabindex="-1" href="author_articles.php"><i class="fa fa-newspaper-o fa-lg"></i> مقالات</a>
					</li>
				</ul>
			</li>
			<li class="<?php echo active(['author_contact']); ?>">
				<a href="author_contact.php"><i class="fa fa-envelope fa-lg"></i> ارتباط با همکاران</a>
			</li>
			<li>
				<a href="logout.php"><i class="fa fa-sign-out fa-lg"></i> خروج</a>
			</li>
		</ul>
	</section>
