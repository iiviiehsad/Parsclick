...
<head>
	...
	<link rel="apple-touch-icon" sizes="57x57"
	      href="<?php echo is_local() ? '' : '/'; ?>images/icons/apple-touch-icon-57x57.png">
	<link rel="apple-touch-icon" sizes="72x72"
	      href="<?php echo is_local() ? '' : '/'; ?>images/icons/apple-touch-icon-72x72.png">
	<link rel="apple-touch-icon" sizes="114x114"
	      href="<?php echo is_local() ? '' : '/'; ?>images/icons/apple-touch-icon-114x114.png">
	<!--CSS Styles-->
