...
<ul>
	...
	<li>برای چپ چین کردن از سی اس اس کلاس <code>edit</code> استفاده کنید.</li>
	<li>برای استفاده از تگ <code>code</code> از دو کاراکتر <code>Backtick</code> استفاده کنید برای مثال: <code>`Your Code`</code> استفاده کنید.</li>
	<li>برای استفاده از تگ <code>strong</code> از دو کاراکتر <code>*</code> استفاده کنید برای مثال: <strong>*Amir Azimi*</strong> استفاده کنید.</li>
...
class="language-php"&gt; کدهای شما &lt;/code&gt;&lt;/pre&gt;</code></pre>
	...
	<li>سوالات مربوط به هر درس را در انجمن مخصوص به همون درس مطرح کنید. اگر سوال نامرتبط به درس یا سوال مرتبط به درس دیگری داخل درس نامرتبط مطرح کنید، سوال جواب داده نخواهد شد.</li>
</ul>