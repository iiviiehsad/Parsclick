	...
	public function email_confirmation_details($username) {
		...
		if($user && isset($user->token)) {
			...
			<body style="background-color:#F5F5DC;direction:rtl;font-family:Tahoma;">
				...
				<p>خوب یک خوش آمد و استقبال گرم را از طرف بجه های پارس کلیک بپذیرید و ممنونیم که ما را انتخاب کردید.<br />
				...
				<li>اگر سوالی داشتید دو مورد دروس ، مقالات داشتید در قسمت تظرات مربوط به هر کدام بنویسید.</li>
