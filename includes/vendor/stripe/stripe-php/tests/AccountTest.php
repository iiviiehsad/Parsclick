...
class AccountTest extends TestCase {
	...
	{
		$this->mockRequest('POST', '/v1/accounts', array('managed' => 'true'), $this->managedAccountResponse('acct_ABC'));
	...
	public function testDelete()
	{
		...
		$this->mockRequest('DELETE', '/v1/accounts/' . $account->id, array(), $this->deletedAccountResponse('acct_ABC'));
	...
	public function testUpdateAdditionalOwners()
	{
		...
		$response['legal_entity']['additional_owners'] = array(
			array(
				'first_name'   => 'Bob',
				'last_name'    => NULL,
				'address'      => array(
