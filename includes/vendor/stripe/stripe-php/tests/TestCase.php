...
class TestCase extends \PHPUnit_Framework_TestCase {
	...
	protected static function createTestCharge(array $attributes = array())
	{
		...
		return Charge::create($attributes + array(
				'amount'      => 2000,
				'currency'    => 'usd',
	...
	protected static function createTestTransfer(array $attributes = array())
	{
		...
		return Transfer::create($attributes + array(
				'amount'      => 2000,
				'currency'    => 'usd',
	...
	protected static function createTestRecipient(array $attributes = array())
	{
		...
		return Recipient::create($attributes + array(
				'name'         => 'PHP Test',
				'type'         => 'individual',
				'tax_id'       => '000000000',
				'bank_account' => array(
	...
	protected static function createTestCustomer(array $attributes = array())
	{
		...
		return Customer::create($attributes + array(
				'card' => array(
					'number'    => '4242424242424242',
					'exp_month' => 5,
					'exp_year'  => date('Y') + 3,
	...
	protected static function createTestAccount(array $attributes = array())
	{
		...
		return Account::create($attributes + array(
				'managed' => FALSE,
				'country' => 'US',
	...
	{
		$receiver = BitcoinReceiver::create(array(
				'amount'      => 100,
				'currency'    => 'usd',
