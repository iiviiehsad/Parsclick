			...
			<form class="form-horizontal"
				...
				<fieldset>
					...
					<section class="row">
						...
						<div class="controls">
							<input class="col-xs-12 col-sm-8 col-md-8 col-lg-8" type="text" name="course_name" id="course_name"
							       autofocus placeholder="اسم درس" value="<?php echo htmlentities($current_course->name); ?>"/>
						</div>
					</section>
					<!--YouTube Playlist ID-->
					<section class="row">
					...
					<section class="row">
						...
						<div class="controls">
							<textarea class="col-xs-12 col-sm-8 col-md-8 col-lg-8" name="content" id="desc" cols="30" rows="10"
							          placeholder="توضیحات" required><?php echo htmlentities($current_course->content); ?></textarea>
						</div>
					</section>
					<!--buttons-->
					<section class="row">
						<div class="controls col-sm-offset-4 col-md-offset-4 col-lg-offset-4">
							<a class="btn btn-danger"
							   href="admin_courses.php?category=<?php echo urlencode($current_category->id); ?>&course=<?php echo urlencode($current_course->id); ?>">لغو</a>
